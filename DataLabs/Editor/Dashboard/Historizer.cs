...
namespace Voidex.DataLabs.Dashboard
{
    public class Historizer : VisualElement
    {
        ...
        public void AddAndHistorize()
        {
            ...
            if (m_history.Count > 0 && m_history.Last() == DataLabsDashboard.CurrentSelectedAsset) return;
            if (m_history.Contains(DataLabsDashboard.CurrentSelectedAsset)) return;

            m_history.Add(DataLabsDashboard.CurrentSelectedAsset);
            ...
            DataLabsEditorSettings.SetString(DataLabsEditorSettings.LabsData.BreadcrumbBarGuids, sb.ToString());
            BuildBreadcrumbs();
        }
        ...
        private void RestoreHistory()
        {
            ...
            string guidblob = DataLabsEditorSettings.GetString(DataLabsEditorSettings.LabsData.BreadcrumbBarGuids);
        ...
        public void GoToHistoryIndex(int index)
        {
            ...
            DataLabsDashboard.Instance.InspectAssetRemote(m_history[index], m_history[index].GetType());
        }
    }
}