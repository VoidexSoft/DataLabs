...
{
    public class DataLabsDashboardDragManipulator : PointerManipulator
    {
        ...
        public DataLabsDashboardDragManipulator(VisualElement origin, VisualElement rootWindow)
        {
        ...
        private void PointerMoveHandler(PointerMoveEvent evt)
        {
            ...
            if (hovered is Button
                && hovered.parent is GroupFoldableButton groupbutton
                && FilterColumnInheritance.CustomGroupsFoldout.Q<GroupFoldableButton>(groupbutton.name) != null)
            {
        ...
        private void PointerUpHandler(PointerUpEvent evt)
        {
            ...
            {
                m_currentHoverTarget.DataGroup.AddEntity(DataLabsDashboard.CurrentSelectedAsset);
            }
